...
pub const LABEL_TEXT: Color = Color::BLACK;
pub const HEADER_TEXT: Color = Color::BLACK;
/// Lobby status / coin HUD accent (kept yellow for readability on the map).
pub const LOBBY_TEXT: Color = Color::srgb(0.867, 0.827, 0.412);
